...
namespace Denny_TameMobsNS
{
    public static class TameUtil
    {
        ...
        public static void TameMob(Enemy enemyBro)
        {
            ...
            ForceClearMobInventory(enemyBro);
        ...
        public static void ForceClearMobInventory(Enemy enemyBro)
        {
            ...
            {
                float randomNSValue = (float)Math.Round(UnityEngine.Random.Range(0.3f, 1f), 3);

                float randomWEValue = (float)Math.Round(UnityEngine.Random.Range(-1f, 1f), 3);

                enemyBro.MyGameCard.Unequip(eq);
                eq.MyGameCard.SendDirection(new UnityEngine.Vector3(randomWEValue, 0f, randomNSValue));
                //eq.MyGameCard.DestroyCard(false, false);
            }
        }
